  ...
  return (
    <section className="a02-review" aria-labelledby="progress-title">
      <div className="a02-view-head">
        ...
        <div className="a02-view-controls"><button type="button" onClick={() => void load()}>Refresh</button><button className="a02-export" type="button" onClick={() => setRecordOpen(true)}>View record ↗</button></div>
      </div>
