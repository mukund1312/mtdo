...
(This section previously routed to a suite of gstack skills -- /office-hours,
/plan-ceo-review, /plan-eng-review, /design-consultation, /plan-design-review,
/autoplan, /investigate, /qa, /qa-only, /design-review, /ship, /land-and-deploy,
/context-save, /context-restore, /spec -- all removed from this machine along with
the rest of gstack. None have a direct non-gstack equivalent; /code-review above is
